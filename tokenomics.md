...
| Human allocation | 100,000,000 VIN | 10% |

Notes:
- The LP VIN reserve exists so the pool can be seeded at the **same price as the sale** while only allocating a portion of sale ETH to liquidity.
